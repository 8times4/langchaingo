...
type VectorStore interface {
	...
	SimilaritySearch(ctx context.Context, query string, numDocuments int, options ...Option) ([]schema.Document, []float64, error) //nolint:lll
}
...
func (r Retriever) GetRelevantDocuments(ctx context.Context, query string) ([]schema.Document, []float64, error) {
